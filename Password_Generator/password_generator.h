...
private slots:
    ...
    void generate_password(QString* password, int* length, int* counting, int character_variants_array[], int* character_variants_count);

    void fill_options_arr(int* add_numbers, int* add_lowercase_letters, int* add_capital_letters,
                 int* add_special_characters, int character_variants_array[]);
